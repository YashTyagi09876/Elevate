  ...
  return (
    ...
    <img src={bg1} className="absolute right-0 top-0 h-[35%]" alt="Background" />
         ...
         <div className=' relative z-40'>
            <h1 className='text-[#03393C] font-bold text-[90.48px] text-center '>Bootcapms</h1>
         ...
         <div className="  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 relative z-50 md:py-10 ">
        {courses.map((course, index) => (
          <div
            key={index}
            className= " group bg-white hover:bg-[#03393c] shadow-lg rounded-2xl  overflow-hidden relative  "
          >
            ...
            <div className=" ">
              ...
              <h3 className=" w-[95%] text-[24px] font-bold mt-2 px-4  text-[#03393c] group-hover:text-white">{course.title}</h3>
              <p className="text-[12px] px-4 text-gray-600 mt-1 group-hover:text-white">{course.description}</p>
              <p className="text-sm font-semibold mt-2 text-[24px] px-4 group-hover:text-white">Starts on: <span className='text-[#4A9274] group-hover:text-white'>{course.startsIn}</span></p>
              <div className="flex items-center justify-between mt-3 bg-[#03393c]  group-hover:bg-[#4a9274] py-6 px-6 ">
